...
1Password Extension for iOS allows you to add support for 1Password and other password managers to your iOS app with just a few lines of code.

[1Password Extension for iOS](https://github.com/agilebits/onepassword-app-extension)
```
